...
import { DeenruvUITable, ListLocations } from '@/types/index.js';
import { useSettings } from '@/state/settings.js';
import { DEFAULT_CHANNEL_CODE } from '@/consts/defaultChannel.js';
import { apiClient } from '@/zeus_client/deenruvAPICall.js';

type RowAction<K extends keyof typeof ListLocations> = NonNullable<DeenruvUITable<K>['rowActions']>[number];

export const EntityChannelManagementRowAction = <K extends keyof typeof ListLocations>(): RowAction<K>[] => {
