...
export type FilterInputType = {
  StringOperators: ModelTypes["StringOperators"] & {
    __typename?: "StringOperators";
  };
  IDOperators: ModelTypes["IDOperators"] & { __typename?: "IDOperators" };
  BooleanOperators: ModelTypes["BooleanOperators"] & {
    __typename?: "BooleanOperators";
  };
  DateOperators: ModelTypes["DateOperators"] & { __typename?: "DateOperators" };
  NumberOperators: ModelTypes["NumberOperators"] & {
    __typename?: "NumberOperators";
  };
};

export type FilterInputTypeUnion =
  | FilterInputType["StringOperators"]
  | FilterInputType["IDOperators"]
  | FilterInputType["BooleanOperators"]
  | FilterInputType["DateOperators"]
  | FilterInputType["NumberOperators"];
...
export const roleFilterFields: readonly {
  name: keyof Pick<
    ModelTypes["RoleFilterParameter"],
    "createdAt" | "description" | "updatedAt" | "code"
  >;
  type: InputType;
}[] = [
  { name: "createdAt", type: "DateOperators" },
...
export const channelFilterFields: readonly {
  name: keyof Pick<
    ModelTypes["ChannelFilterParameter"],
    "createdAt" | "code" | "updatedAt" | "token"
  >;
  type: InputType;
}[] = [
  { name: "createdAt", type: "DateOperators" },
...
export const zoneFilterFields: readonly {
  name: keyof Pick<
    ModelTypes["ZoneFilterParameter"],
...
export const taxCategoryFilterFields: readonly {
  name: keyof Pick<
    ModelTypes["TaxCategoryFilterParameter"],
    "createdAt" | "name" | "updatedAt"
  >;
  type: InputType;
}[] = [
...
export const taxRateFilterFields: readonly {
  name: keyof Pick<
    ModelTypes["TaxRateFilterParameter"],
    "createdAt" | "name" | "updatedAt" | "value" | "enabled"
  >;
  type: InputType;
}[] = [
  { name: "createdAt", type: "DateOperators" },
...
export const stockLocationFilterFields: readonly {
  name: keyof Pick<
    ModelTypes["StockLocationFilterParameter"],
    "createdAt" | "name" | "updatedAt" | "description"
  >;
  type: InputType;
}[] = [
  { name: "createdAt", type: "DateOperators" },
...
export const sellerFilterFields: readonly {
  name: keyof Pick<
    ModelTypes["SellerFilterParameter"],
    "createdAt" | "name" | "updatedAt"
  >;
  type: InputType;
}[] = [
