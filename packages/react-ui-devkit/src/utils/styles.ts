  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-stone-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-stone-950 dark:focus-visible:ring-stone-300",
  {
    variants: {
      variant: {
        ...
        action:
          "bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-400 dark:bg-blue-500 dark:text-white dark:hover:bg-blue-600",
        outline:
        ...
        ghost:
          "text-stone-900 hover:bg-stone-100 focus:ring-2 focus:ring-stone-300 dark:text-stone-50 dark:hover:bg-stone-800",
        "navigation-link":
          "text-navigation-link focus:ring-navigation-link/50 dark:focus:ring-navigation-link/50 opacity-70 hover:opacity-100 focus:opacity-100 focus:ring-2 dark:opacity-80 dark:hover:opacity-100",
