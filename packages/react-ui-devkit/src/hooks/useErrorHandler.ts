...
export function useErrorHandler() {
    ...
    const parseError = useCallback(
        (errorMessage: string) => {
            const errorParsers: { [key: string]: (msg: string, t: any) => string | null } = {
...
function parseForeignKeyError(errorMessage: string, t: (key: string, params?: any) => string): string | null {
