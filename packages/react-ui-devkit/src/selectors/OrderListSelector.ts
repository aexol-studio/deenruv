...
export type DiscountsType = FromSelectorWithScalars<
...
export type ShippingLineType = FromSelectorWithScalars<
...
export type ShippingMethodType = FromSelectorWithScalars<
...
export type ActiveOrderType = FromSelectorWithScalars<
