...
export type PaymentMethodsType = FromSelectorWithScalars<
  typeof paymentMethodsSelector,
  "PaymentMethod"
>;

export const serverConfigSelector = Selector("ServerConfig")({
  entityCustomFields: {
    customFields: CustomFieldConfigSelector,
    entityName: true,
  },
...
export type ServerConfigType = FromSelectorWithScalars<
  typeof serverConfigSelector,
  "ServerConfig"
>;
...
export type ChannelType = FromSelectorWithScalars<
  typeof channelSelector,
  "Channel"
>;
...
export type CountryType = FromSelectorWithScalars<
  typeof countrySelector,
  "Country"
>;

export const configurableOperationDefinitionSelector = Selector(
