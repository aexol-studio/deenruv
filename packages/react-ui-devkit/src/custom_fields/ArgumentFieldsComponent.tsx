  ...
  useEffect(() => {
    ...
    for (const arg of args) {
      const action = actions.find((a) =>
        a.args.some((ar) => ar.name === arg.name),
      );
        ...
        [
          {
            ...
            description: [
              { languageCode: "en", value: argument.description || "" },
            ],
          },
        ],
        getInputComponent,
      ...
      result[action.code][arg.name] = components.filter(
        (c) => c.name === arg.name,
      );
    }
          ...
          return (
            <div key={argName}>
              {components.map(({ component }, i) => {
                ...
                const description = [
                  { languageCode: "en", value: field.description || "" },
                ];
