...
export class ConfigArgService {
  ...
  constructor(private configService: ConfigService) {
    this.definitionsByType = {
      ...
      FulfillmentHandler:
        this.configService.shippingOptions.fulfillmentHandlers,
  ...
  getByCode<T extends ConfigDefType>(
    ...
    if (!match) {
      throw new UserInputError(
        "error.no-configurable-operation-def-with-code-found",
        {
          code,
          type: defType,
        },
