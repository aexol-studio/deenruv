...
export class StockLocationResolver {
  ...
  stockLocation(
    ...
    @Args() args: QueryStockLocationArgs,
  ) {
  ...
  stockLocations(
    @Ctx() ctx: RequestContext,
    @Args() args: QueryStockLocationsArgs,
  ) {
  ...
  createStockLocation(
    @Ctx() ctx: RequestContext,
    @Args() args: MutationCreateStockLocationArgs,
  ) {
  ...
  updateStockLocation(
    @Ctx() ctx: RequestContext,
    @Args() args: MutationUpdateStockLocationArgs,
  ) {
  ...
  deleteStockLocation(
    @Ctx() ctx: RequestContext,
    @Args() args: MutationDeleteStockLocationArgs,
  ) {
  ...
  deleteStockLocations(
    @Ctx() ctx: RequestContext,
    @Args() args: MutationDeleteStockLocationsArgs,
  ) {
    return Promise.all(
      args.input.map((input) => this.stockLocationService.delete(ctx, input)),
    );
  }
  ...
  assignStockLocationsToChannel(
    ...
    return this.stockLocationService.assignStockLocationsToChannel(
      ctx,
      args.input,
    );
  }
  ...
  removeStockLocationsFromChannel(
    ...
    return this.stockLocationService.removeStockLocationsFromChannel(
      ctx,
      args.input,
    );
  }
