...
export class ProductResolver {
  ...
  async productVariants(
    ...
    @Relations({ entity: ProductVariant, omit: ["assets"] })
  ...
  async updateProducts(
    ...
    return await Promise.all(
      args.input.map((i) => this.productService.update(ctx, i)),
    );
  }
  ...
  async deleteProducts(
    ...
    return Promise.all(
      args.ids.map((id) => this.productService.softDelete(ctx, id)),
    );
  }
  ...
  async addOptionGroupToProduct(
    ...
    return this.productService.addOptionGroupToProduct(
      ctx,
      productId,
      optionGroupId,
    );
  ...
  > {
    ...
    return this.productService.removeOptionGroupFromProduct(
      ctx,
      productId,
      optionGroupId,
      force,
  ...
  async deleteProductVariants(
    ...
    return Promise.all(
      args.ids.map((id) => this.productVariantService.softDelete(ctx, id)),
    );
  }
  ...
  async assignProductVariantsToChannel(
    ...
    return this.productVariantService.assignProductVariantsToChannel(
      ctx,
      args.input,
    );
  }
