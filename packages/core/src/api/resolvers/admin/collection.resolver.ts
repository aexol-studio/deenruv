...
export class CollectionResolver {
  ...
  async collection(
    ...
    if (args.id) {
      collection = await this.collectionService.findOne(
        ctx,
        args.id,
        relations,
      );
      ...
      collection = await this.collectionService.findOneBySlug(
        ctx,
        args.slug,
        relations,
      );
  ...
  previewCollectionVariants(
    ...
    return this.collectionService.previewCollectionVariants(
      ctx,
      args.input,
      args.options || undefined,
    );
  ...
  async deleteCollections(
    ...
    return Promise.all(
      args.ids.map((id) => this.collectionService.delete(ctx, id)),
    );
  }
  ...
  async assignCollectionsToChannel(
    ...
    return await this.collectionService.assignCollectionsToChannel(
      ctx,
      args.input,
    );
  }
  ...
  async removeCollectionsFromChannel(
    ...
    return await this.collectionService.removeCollectionsFromChannel(
      ctx,
      args.input,
    );
  }
