...
export class CustomerResolver {
  ...
  async customers(
    ...
    @Relations({ entity: Customer, omit: ["orders"] })
  ...
  async addNoteToCustomer(
    @Ctx() ctx: RequestContext,
    @Args() args: MutationAddNoteToCustomerArgs,
  ) {
  ...
  async updateCustomerNote(
    @Ctx() ctx: RequestContext,
    @Args() args: MutationUpdateCustomerNoteArgs,
  ) {
  ...
  async deleteCustomerNote(
    @Ctx() ctx: RequestContext,
    @Args() args: MutationDeleteCustomerNoteArgs,
  ) {
