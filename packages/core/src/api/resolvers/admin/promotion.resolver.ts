...
export class PromotionResolver {
  ...
  promotions(
    ...
    return this.promotionService
      .findAll(ctx, args.options || undefined, relations)
      .then((res) => {
  ...
  promotion(
    ...
    return this.promotionService
      .findOne(ctx, args.id, relations)
      .then(this.encodeConditionsAndActions);
  }
  ...
  createPromotion(
    ...
    return this.promotionService
      .createPromotion(ctx, args.input)
      .then(this.encodeConditionsAndActions);
  }
  ...
  updatePromotion(
    ...
    return this.promotionService
      .updatePromotion(ctx, args.input)
      .then(this.encodeConditionsAndActions);
  }
  ...
  deletePromotions(
    ...
    return Promise.all(
      args.ids.map((id) => this.promotionService.softDeletePromotion(ctx, id)),
    );
  }
