...
export class PaymentMethodResolver {
  ...
  deletePaymentMethods(
    ...
    return Promise.all(
      args.ids.map((id) =>
        this.paymentMethodService.delete(ctx, id, args.force),
      ),
    );
  }
  ...
  async assignPaymentMethodsToChannel(
    ...
    return await this.paymentMethodService.assignPaymentMethodsToChannel(
      ctx,
      args.input,
    );
  }
  ...
  async removePaymentMethodsFromChannel(
    ...
    return await this.paymentMethodService.removePaymentMethodsFromChannel(
      ctx,
      args.input,
    );
  }
