...
export class OrderResolver {
  ...
  async settleRefund(
    @Ctx() ctx: RequestContext,
    @Args() args: MutationSettleRefundArgs,
  ) {
  ...
  async addNoteToOrder(
    @Ctx() ctx: RequestContext,
    @Args() args: MutationAddNoteToOrderArgs,
  ) {
  ...
  async updateOrderNote(
    @Ctx() ctx: RequestContext,
    @Args() args: MutationUpdateOrderNoteArgs,
  ) {
  ...
  async deleteOrderNote(
    @Ctx() ctx: RequestContext,
    @Args() args: MutationDeleteOrderNoteArgs,
  ) {
  ...
  async setOrderCustomFields(
    ...
    return this.orderService.updateCustomFields(
      ctx,
      args.input.id,
      args.input.customFields,
    );
  }
  ...
  async setOrderCustomer(
    @Ctx() ctx: RequestContext,
    @Args() { input }: MutationSetOrderCustomerArgs,
  ) {
  ...
  async transitionOrderToState(
    ...
    return this.orderService.transitionToState(
      ctx,
      args.id,
      args.state as OrderState,
    );
  }
  ...
  async transitionFulfillmentToState(
    ...
    return this.orderService.transitionFulfillmentToState(
      ctx,
      args.id,
      args.state as FulfillmentState,
    );
  }
  ...
  async transitionPaymentToState(
    ...
    return this.orderService.transitionPaymentToState(
      ctx,
      args.id,
      args.state as PaymentState,
    );
  }
  ...
  async modifyOrder(
    @Ctx() ctx: RequestContext,
    @Args() args: MutationModifyOrderArgs,
  ) {
