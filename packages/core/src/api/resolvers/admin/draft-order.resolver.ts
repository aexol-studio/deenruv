...
export class DraftOrderResolver {
  ...
  async adjustDraftOrderLine(
    ...
    if (input.quantity === 0) {
      return this.removeDraftOrderLine(ctx, {
        orderId,
  ...
  async setCustomerForDraftOrder(
    ...
    if (args.customerId) {
      ...
      const result = await this.customerService.createOrUpdate(
        ctx,
        args.input,
        true,
      );
  ...
  async applyCouponCodeToDraftOrder(
    ...
    return this.orderService.applyCouponCode(
      ctx,
      args.orderId,
      args.couponCode,
    );
  ...
  async removeCouponCodeFromDraftOrder(
    ...
    return this.orderService.removeCouponCode(
      ctx,
      args.orderId,
      args.couponCode,
    );
  ...
  async setDraftOrderShippingMethod(
    ...
    return this.orderService.setShippingMethod(ctx, args.orderId, [
