...
import { Mutation, Query } from "@deenruv/common/lib/generated-shop-types";
import {
  buildASTSchema,
...
} from "../../config/order/active-order-strategy";
...
export function generateActiveOrderTypes(
  ...
  const activeOrderOperations: Array<{
