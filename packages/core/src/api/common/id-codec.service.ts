...
export class IdCodecService {
  ...
  constructor(configService: ConfigService) {
    this.idCodec = new IdCodec(
      configService.entityOptions.entityIdStrategy ??
        configService.entityIdStrategy,
    );
  }

  encode<T extends string | number | boolean | object | undefined>(
    target: T,
  ...
  decode<T extends string | number | object | undefined>(
    target: T,
    transformKeys?: string[],
  ): T {
