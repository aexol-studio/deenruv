import { SearchInput as GeneratedSearchInput } from "@deenruv/common/lib/generated-types";
...
export type UpdateProductJobData = NamedJobData<
  "update-product",
  UpdateProductMessageData
>;
export type UpdateVariantsJobData = NamedJobData<
  "update-variants",
  UpdateVariantMessageData
>;
export type DeleteProductJobData = NamedJobData<
  "delete-product",
  UpdateProductMessageData
>;
export type DeleteVariantJobData = NamedJobData<
  "delete-variant",
  UpdateVariantMessageData
>;
export type UpdateVariantsByIdJobData = NamedJobData<
  "update-variants-by-id",
  UpdateVariantsByIdMessageData
>;
export type UpdateAssetJobData = NamedJobData<
  "update-asset",
  UpdateAssetMessageData
>;
export type DeleteAssetJobData = NamedJobData<
  "delete-asset",
  UpdateAssetMessageData
>;
