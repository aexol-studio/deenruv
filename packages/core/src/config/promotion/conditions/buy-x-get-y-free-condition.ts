...
export const buyXGetYFreeCondition = new PromotionCondition({
  ...
  args: {
    ...
    variantIdsX: {
      ...
      label: [
        {
          languageCode: LanguageCode.en,
          value: "Buy amountX of these variants",
        },
      ],
    },
    amountY: {
    ...
    variantIdsY: {
      ...
      label: [
        {
          languageCode: LanguageCode.en,
          value: "Get amountY of these variants for free",
        },
      ],
    },
  },
  async check(ctx, order, args) {
    ...
    const freeLines = freeItemCandidates.sort((a, b) => {
      const unitPriceA = ctx.channel.pricesIncludeTax
        ? a.unitPriceWithTax
        : a.unitPrice;
      const unitPriceB = ctx.channel.pricesIncludeTax
        ? b.unitPriceWithTax
        : b.unitPrice;
