...
describe("PaymentMethod resolver", () => {
  ...
  it("paymentMethodEligibilityCheckers", async () => {
    const { paymentMethodEligibilityCheckers } =
      await adminClient.query<Codegen.GetPaymentMethodCheckersQuery>(
  ...
  it("paymentMethodHandlers", async () => {
    const { paymentMethodHandlers } =
      await adminClient.query<Codegen.GetPaymentMethodHandlersQuery>(
  ...
  describe("eligibility checks", () => {
    ...
    it("addPaymentToOrder does not allow ineligible method", async () => {
      ...
      expect(addPaymentToOrder.eligibilityCheckerMessage).toBe(
        "Order total too low",
      );
  ...
  describe("channels", () => {
    ...
    it("method is listed in channel2", async () => {
      ...
      const { paymentMethods } =
        await adminClient.query<Codegen.GetPaymentMethodListQuery>(
