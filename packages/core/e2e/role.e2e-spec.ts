...
describe("Role resolver", () => {
  ...
  it("roles", async () => {
    const result = await adminClient.query<
      Codegen.GetRolesQuery,
      Codegen.GetRolesQueryVariables
    >(GET_ROLES);
  ...
  it("role", async () => {
    const result = await adminClient.query<
      Codegen.GetRoleQuery,
      Codegen.GetRoleQueryVariables
    >(GET_ROLE, {
      id: createdRole.id,
    });
  ...
  describe("updateRole", () => {
    ...
    it(
      ...
      assertThrowsWithMessage(async () => {
        const superAdminRole = defaultRoles.find(
    ...
    it(
      ...
      assertThrowsWithMessage(async () => {
        const customerRole = defaultRoles.find(
          (r) => r.code === CUSTOMER_ROLE_CODE,
        );
        if (!customerRole) {
  ...
  describe("role escalation", () => {
    ...
    beforeAll(async () => {
      ...
      defaultChannel = channels.items.find(
    ...
    it("limited admin cannot view Role which requires permissions they do not have", async () => {
      const result = await adminClient.query<
        Codegen.GetRoleQuery,
        Codegen.GetRoleQueryVariables
      >(GET_ROLE, { id: orderReaderRole.id });
