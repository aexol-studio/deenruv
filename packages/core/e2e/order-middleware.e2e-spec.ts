...
class OrderMiddleware1 implements OrderMiddleware {
    ...
    shouldRemoveItemFromOrder(ctx: RequestContext, order: Order, orderLine: OrderLine): Promise<void | string> {
        this.shouldRemoveItemFromOrderSpy(ctx, order, orderLine);
        return Promise.resolve();
    }
}
class OrderMiddleware2 implements OrderMiddleware {
    async shouldAddItemToOrder(ctx: RequestContext, order: Order, input: ShouldAddItemToOrderInput) {
...
describe('Order interceptor', () => {
    ...
    it('willAddItemToOrder', async () => {
        ...
        expect(orderMiddleware1.shouldAddItemToOrderSpy.mock.calls[0][0]).toBeInstanceOf(RequestContext);
        expect(orderMiddleware1.shouldAddItemToOrderSpy.mock.calls[0][1]).toBeInstanceOf(Order);
        expect(orderMiddleware1.shouldAddItemToOrderSpy.mock.calls[0][2].quantity).toBe(1);
        expect(orderMiddleware1.shouldAddItemToOrderSpy.mock.calls[0][2].productVariant.id).toBe(1);
        expect(orderMiddleware1.shouldAddItemToOrderSpy.mock.calls[0][2].customFields).toBeUndefined();
    });
    it('willAdjustOrderLine', async () => {
        ...
        expect(orderMiddleware1.shouldAdjustOrderLineSpy.mock.calls[0][0]).toBeInstanceOf(RequestContext);
        expect(orderMiddleware1.shouldAdjustOrderLineSpy.mock.calls[0][1]).toBeInstanceOf(Order);
        expect(orderMiddleware1.shouldAdjustOrderLineSpy.mock.calls[0][2].quantity).toBe(2);
        expect(orderMiddleware1.shouldAdjustOrderLineSpy.mock.calls[0][2].orderLine.id).toBe(1);
        expect(orderMiddleware1.shouldAdjustOrderLineSpy.mock.calls[0][2].customFields).toBeUndefined();
    });
    it('willRemoveItemFromOrder', async () => {
        ...
        expect(orderMiddleware1.shouldRemoveItemFromOrderSpy.mock.calls[0][0]).toBeInstanceOf(RequestContext);
        expect(orderMiddleware1.shouldRemoveItemFromOrderSpy.mock.calls[0][1]).toBeInstanceOf(Order);
        expect(orderMiddleware1.shouldRemoveItemFromOrderSpy.mock.calls[0][2].productVariant.id).toEqual(1);
    });
