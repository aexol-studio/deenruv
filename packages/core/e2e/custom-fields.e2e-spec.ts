...
describe("Custom fields", () => {
  ...
  beforeAll(async () => {
    await server.init({
      ...
      productsCsvPath: path.join(
        __dirname,
        "fixtures/e2e-products-minimal.csv",
      ),
      customerCount: 1,
    });
  ...
  it("globalSettings.serverConfig.entityCustomFields", async () => {
    ...
    const productCustomFields =
      globalSettings.serverConfig.entityCustomFields.find(
  ...
  it("get fields with default values", async () => {
    ...
    const customFields = {
      ...
      stringListWithDefault:
        customConfig.dbConnectionOptions.type === "mysql" ? null : ["cat"],
    };
  ...
  it(
    ...
    assertThrowsWithMessage(async () => {
      await adminClient.query(gql`
        mutation {
          updateProduct(
            input: { id: "T_1", customFields: { notNullable: null } }
          ) {
            id
          }
        }
  ...
  it(
    ...
    assertThrowsWithMessage(async () => {
      await adminClient.query(gql`
        mutation {
          updateProduct(
            input: { id: "T_1", customFields: { readonlyString: "hello" } }
          ) {
            id
          }
        }
    ...
    const result = await adminClient.query(
      gql`
        mutation ($stringValue: String!) {
          updateProduct(
            input: { id: "T_1", customFields: { longString: $stringValue } }
          ) {
            id
            customFields {
              longString
          ...
          updateProduct(
            input: {
              ...
              translations: [
                {
                  languageCode: en
                  customFields: { longLocaleString: $stringValue }
                }
              ]
            }
          ) {
  ...
  describe("validation", () => {
    it(
      ...
      assertThrowsWithMessage(async () => {
        await adminClient.query(gql`
          mutation {
            updateProduct(
              input: { id: "T_1", customFields: { validateString: "hello" } }
            ) {
              id
            }
          }
    ...
    it(
      ...
      assertThrowsWithMessage(async () => {
        await adminClient.query(gql`
          mutation {
            updateProduct(
              input: { id: "T_1", customFields: { stringWithOptions: "tiny" } }
            ) {
              id
            }
          }
    ...
    it("valid string option", async () => {
      const { updateProduct } = await adminClient.query(gql`
        mutation {
          updateProduct(
            input: { id: "T_1", customFields: { stringWithOptions: "medium" } }
          ) {
            id
            customFields {
              stringWithOptions
      ...
      const { updateProduct } = await adminClient.query(gql`
        mutation {
          updateProduct(
            input: {
              id: "T_1"
              customFields: { nullableStringWithOptions: null }
            }
          ) {
            id
            customFields {
    ...
    it(
      ...
      assertThrowsWithMessage(async () => {
        await adminClient.query(gql`
          mutation {
            updateProduct(
              input: { id: "T_1", customFields: { validateInt: 12 } }
            ) {
              id
            }
          }
    ...
    it(
      ...
      assertThrowsWithMessage(async () => {
        await adminClient.query(gql`
          mutation {
            updateProduct(
              input: { id: "T_1", customFields: { validateFloat: 10.6 } }
            ) {
              id
            }
          }
    ...
    it(
      ...
      assertThrowsWithMessage(async () => {
        await adminClient.query(gql`
          mutation {
            updateProduct(
              input: { id: "T_1", customFields: { validateFn1: "invalid" } }
            ) {
              id
            }
          }
    ...
    it(
      ...
      assertThrowsWithMessage(async () => {
        await adminClient.query(gql`
          mutation {
            updateProduct(
              input: { id: "T_1", customFields: { validateFn2: "invalid" } }
            ) {
              id
            }
          }
        ...
        await adminClient.query(gql`
          mutation {
            updateProduct(
              input: {
                id: "T_1"
                customFields: { intListWithValidation: [1, 2, 3] }
              }
            ) {
              id
            }
    ...
    it("valid list field", async () => {
      const { updateProduct } = await adminClient.query(gql`
        mutation {
          updateProduct(
            input: {
              id: "T_1"
              customFields: { intListWithValidation: [1, 42, 3] }
            }
          ) {
            id
            customFields {
      ...
      `);
      expect(updateProduct.customFields.intListWithValidation).toEqual([
        1, 42, 3,
      ]);
    });
    ...
    it("can inject providers into validation fn", async () => {
      const { updateProduct } = await adminClient.query(gql`
        mutation {
          updateProduct(
            input: { id: "T_1", customFields: { validateFn3: "some value" } }
          ) {
            id
            customFields {
              validateFn3
      ...
      expect(
        validateInjectorSpy.mock.calls[0][0] instanceof TransactionalConnection,
      ).toBe(true);
    });
    ...
    it(
      ...
      assertThrowsWithMessage(async () => {
        await adminClient.query(gql`
          mutation {
            updateProduct(
              input: { id: "T_1", customFields: { validateFn4: "some value" } }
            ) {
              id
              customFields {
                validateFn4
    ...
    it(
      ...
      assertThrowsWithMessage(async () => {
        await adminClient.query(gql`
          mutation {
            updateProduct(
              input: { id: "T_1", customFields: { validateRelationId: "T_1" } }
            ) {
              id
              customFields {
                validateFn4
    ...
    it("handles well graphql internal fields", async () => {
      ...
      await adminClient.query(gql`
        mutation {
          __typename
          updateProduct(
            input: { id: "T_1", customFields: { nullable: "some value" } }
          ) {
            __typename
            id
            customFields {
  ...
  describe("sort & filter", () => {
    ...
    it("can filter by custom fields", async () => {
      const { products } = await adminClient.query(gql`
        query {
          products(
            options: { filter: { stringWithDefault: { contains: "hello" } } }
          ) {
            totalItems
          }
        }
    ...
    it("can filter by localeString custom fields", async () => {
      const { products } = await adminClient.query(gql`
        query {
          products(
            options: {
              filter: { localeStringWithDefault: { contains: "hola" } }
            }
          ) {
            totalItems
          }
    ...
    it("can filter by custom list fields", async () => {
      const { products: result1 } = await adminClient.query(gql`
        query {
          products(
            options: { filter: { intListWithValidation: { inList: 42 } } }
          ) {
            totalItems
          }
        }
      ...
      const { products: result2 } = await adminClient.query(gql`
        query {
          products(
            options: { filter: { intListWithValidation: { inList: 43 } } }
          ) {
            totalItems
          }
        }
    ...
    it(
      ...
      assertThrowsWithMessage(async () => {
        await adminClient.query(gql`
          query {
            products(
              options: { filter: { internalString: { contains: "hello" } } }
            ) {
              totalItems
            }
          }
  ...
  describe("unique constraint", () => {
    it("setting unique value works", async () => {
      const result = await adminClient.query(gql`
        mutation {
          updateProduct(
            input: { id: "T_1", customFields: { uniqueString: "foo" } }
          ) {
            id
            customFields {
              uniqueString
    ...
    it("setting conflicting value fails", async () => {
      try {
        ...
        switch (customConfig.dbConnectionOptions.type) {
          ...
          case "sqljs":
            duplicateKeyErrMessage =
              "UNIQUE constraint failed: product.customFieldsUniquestring";
            break;
        }
