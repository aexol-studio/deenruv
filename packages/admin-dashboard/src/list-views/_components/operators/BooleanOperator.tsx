  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-center gap-4">
        <Select value={currentType as string} onValueChange={(e) => setCurrentType(e as keyof BooleanOperator)}>
          <SelectTrigger>
      ...
      <Button onClick={() => onSubmit({ [currentType]: value })} variant="outline" className="w-fit self-end">
        {t('buttons.apply')}
      </Button>
    </div>
  );
