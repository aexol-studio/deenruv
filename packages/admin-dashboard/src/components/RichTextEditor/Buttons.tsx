...
export const SimpleButton: React.FC<PropsWithChildren<EditorButtonProps>> = ({ children, onClick, disabled }) => {
  return (
...
export const ToggleGroupButton: React.FC<PropsWithChildren<EditorToggleGroupButtonProps>> = ({ children, value }) => {
  return (
