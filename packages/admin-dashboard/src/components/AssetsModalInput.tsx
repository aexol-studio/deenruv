        ...
        <div className="flex h-[calc(90vh-140px)] w-full flex-col gap-2 ">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="start" className="max-h-[400px] overflow-y-auto">
                  {tags
                    ...
                    .map((i) => (
                      <DropdownMenuItem key={i.id} onClick={() => setSearchTags((p) => [...p, i.value])}>
                        {i.value}
                      </DropdownMenuItem>
                    ))}
                </DropdownMenuContent>
              ...
              <div className="flex w-full flex-1 flex-wrap gap-2">
                {assets.map((asset) => (
                  <div
                    ...
                    onClick={() => setSelectedAsset((p) => (p?.id !== asset.id ? asset : undefined))}
                  >
                    <ImageWithPreview
                    ...
                    <HoverCard>
                      <HoverCardTrigger asChild>
                        <div className="max-w-[150px] truncate px-2 pt-1.5 text-xs">{asset.name}</div>
                      </HoverCardTrigger>
                      <HoverCardContent className={cn('rounded border p-1 text-center text-xs')}>
          ...
          <div className="gap-2, flex w-full flex-wrap justify-between">
            <div className="flex gap-2">
              ...
              <Select value={perPage.toString()} onValueChange={(e) => setPerPage(parseInt(e) as ASSETS_PER_PAGE)}>
            ...
            <div>
              <Pagination>
                <PaginationContent>
                  <PaginationPrevious isActive={page !== 1} onClick={() => setPage((p) => p - 1)} />
                  ...
                  <PaginationNext isActive={page !== totalPages} onClick={() => setPage((p) => p + 1)} />
                </PaginationContent>
              </Pagination>
            </div>
