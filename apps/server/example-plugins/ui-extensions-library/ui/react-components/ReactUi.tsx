  ...
  return (
    <>
      ...
      >
        <PageBlock>
          <Card title="Card">
            This is a card. On a detail page, content should usually be placed
            inside a card.
          </Card>
          <Card title="Form inputs">
            <div className="form-grid">
              ...
              <FormField
                label="With tooltip"
                tooltip="This is a tooltip for the form input"
              >
                <input type="text" />
              </FormField>
          ...
          <Card title={"Buttons"}>
            ...
            <DemoBlock label="Ghost">
              ...
              <Link
                ...
                href="/extensions/ui-library/react-ui"
              >
