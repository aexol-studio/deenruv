...
import type { ListQueryOptions, PaginatedList, RelationPaths, RequestContext } from '@deenruv/core';
    ...
    findAll(
        ...
        return this.listQueryBuilder
            .build(SupplierStock, options, {
                ctx,
                relations: relations ?? ['product', 'productVariant', 'supplier', 'stocksInTransits'],
            })
            .getManyAndCount()
