...
import { useInjector, usePageMetadata } from "@deenruv/admin-ui/react";
  ...
  return (
    <div className="page-block">
      ...
      <div className="card">
        <input
          value={titleValue}
          onInput={(e) => setTitleValue((e.target as any).value)}
        />
        <button
          className="button secondary"
          onClick={() => setTitle(titleValue)}
        >
          Set title
        </button>
      </div>
      <div className="card">
        ...
        <button
          className="button secondary"
          onClick={() => setBreadcrumb(breadcrumbValue)}
        >
          Set breadcrumb
        </button>
      </div>
