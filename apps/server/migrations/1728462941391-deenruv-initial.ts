...
export class DeenruvInitial1728462941391 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f3a761f6bcfabb474b11e1e51f"`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e5598363000cab9d9116bd5835"`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_94e15d5f12d355d117390131ac"`,
      undefined,
    );
    await queryRunner.query(
