...
export const ShippingMethodDetailsPage = () => {
  const { id } = useParams();
  ...
  const createShippingMethod = useCallback(() => {
    apiCall()('mutation')({
      ...
      .then((resp) => {
        ...
        navigate(Routes.shippingMethod.to(resp.createShippingMethod.id));
      })
  ...
  const setTranslationField = useCallback(
    (field: string, e: string | ModelTypes['ShippingMethodTranslationCustomFields']) => {
      setField(
        'translations',
