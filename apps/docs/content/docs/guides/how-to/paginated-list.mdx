...
[`ListQueryBuilder`](/docs/reference/typescript-api/data-access/list-query-builder/) to build the list query. The
...
[customPropertyMap](/docs/reference/typescript-api/data-access/list-query-builder/#custompropertymap) option:
