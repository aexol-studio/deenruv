...
<Callout type="info">
The complete source of the following example plugin can be found here: [example-plugins/digital-products](https://github.com/aexol-studio/deenruv/tree/main/packages/dev-server/example-plugins/digital-products)
</Callout>
...
The complete plugin can be found here: [example-plugins/digital-products](https://github.com/aexol-studio/deenruv/tree/main/packages/dev-server/example-plugins/digital-products)
