...
description: 'Learn how to add support for digital products like ebooks, software, and downloads in Deenruv'
---
...
This guide will show you how you can add support for digital products to Deenruv.

## Creating the plugin

<Callout type="info">
The complete source of the following example plugin can be found here: [example-plugins/digital-products](https://github.com/aexol-studio/deenruv/tree/master/packages/dev-server/example-plugins/digital-products)
</Callout>
...
The complete plugin can be found here: [example-plugins/digital-products](https://github.com/aexol-studio/deenruv/tree/master/packages/dev-server/example-plugins/digital-products)

We can now add the plugin to the DeenruvConfig:
...
Once these parts have been defined and bundled up in a Deenruv plugin, we can create a new ShippingMethod via the Admin UI, and
