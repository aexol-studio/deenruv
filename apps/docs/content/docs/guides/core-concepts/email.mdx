...
Order changes. The EmailPlugin ships with a set of [default email handlers](https://github.com/aexol-studio/deenruv/blob/main/packages/email-plugin/src/default-email-handlers.ts),
