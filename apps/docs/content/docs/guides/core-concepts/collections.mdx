---
title: 'Collections'
description: 'Learn about Collections - how to organize and categorize your product catalog using filters and hierarchies'
---

import { Callout } from 'fumadocs-ui/components/callout';

[`Collections`](/docs/reference/typescript-api/entities/collection/) are used to categorize and organize your catalog. A collection
...
The specific product variants that belong to a collection are determined by the collection's [`CollectionFilters`](/docs/reference/typescript-api/configuration/collection-filter/).
A collection filter is a piece of logic which is used to determine whether a product variant should be included in the collection. By default, Deenruv
...
You can create your own custom collection filters with the [`CollectionFilter`](/docs/reference/typescript-api/configuration/collection-filter/) class. This class
is a [configurable operation](/docs/guides/developer-guide/strategies-configurable-operations/#configurable-operations) where the specific
...
[default collection filters](https://github.com/aexol-studio/deenruv/blob/master/packages/core/src/config/catalog/default-collection-filters.ts).
</Callout>
