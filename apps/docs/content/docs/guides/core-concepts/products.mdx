...
Your catalog is composed of [`Products`](/docs/reference/typescript-api/entities/product) and [`ProductVariants`](/docs/reference/typescript-api/entities/product-variant).
...
Multiple variants are made possible by adding one or more [`ProductOptionGroups`](/docs/reference/typescript-api/entities/product-option-group) to
the product. These option groups then define the available [`ProductOptions`](/docs/reference/typescript-api/entities/product-option)
...
relations to one or more [`ProductVariantPrice`](/docs/reference/typescript-api/entities/product-variant-price) entities and
one or more [`StockLevel`](/docs/reference/typescript-api/entities/stock-level) entities.



## Facets

[`Facets`](/docs/reference/typescript-api/entities/facet) are used to add structured labels to products and variants. A facet has
one or more [`FacetValues`](/docs/reference/typescript-api/entities/facet-value). Facet values can be assigned to products or
product variants.
