...
description: 'Build navigation menus using collection hierarchies in your Deenruv storefront'
---
...
Typically, navigation is based on a hierarchy of [collections](/docs/guides/core-concepts/collections/). We can get the top-level
