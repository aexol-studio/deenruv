---
title: "Try the API"
description: "Explore the Deenruv GraphQL APIs with hands-on examples"
---

import { Callout } from 'fumadocs-ui/components/callout';

Once you have successfully installed Deenruv locally following the [installation guide](/docs/guides/getting-started/installation),
it's time to try out the API!

<Callout type="info">
This guide assumes you chose to populate sample data when installing Deenruv.

You can also follow along with these example using the public demo playground at [demo.deenruv.com/shop-api](https://demo.deenruv.com/shop-api)
</Callout>

## GraphQL Playground

The Deenruv server comes with a GraphQL Playground which allows you to explore the API and run queries and mutations. It is
...
Open the GraphQL Playground at [http://localhost:6100/shop-api](http://localhost:6100/shop-api).
...
<Callout type="info">
For more information about `ErrorResult` and the handling of errors in Deenruv, see the [Error Handling guide](/docs/guides/developer-guide/error-handling).
</Callout>
...
Open the GraphQL Playground at [http://localhost:6100/admin-api](http://localhost:6100/admin-api).
