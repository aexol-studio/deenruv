...
Możesz również śledzić te przykłady, korzystając z publicznego demo pod adresem [demo.deenruv.com/shop-api](https://demo.deenruv.com/shop-api)
</Callout>
...
Otwórz GraphQL Playground pod adresem [http://localhost:6100/shop-api](http://localhost:6100/shop-api).
...
Otwórz GraphQL Playground pod adresem [http://localhost:6100/admin-api](http://localhost:6100/admin-api).
