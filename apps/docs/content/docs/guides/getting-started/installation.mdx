---
title: "Installation"
description: "Get started with Deenruv in minutes"
---
...
-   The [supported TypeScript version](https://github.com/aexol-studio/deenruv/blob/main/packages/create/src/constants.ts#L7) is set upon installation. Upgrading to a newer version of TypeScript might result in compilation errors.
...
The recommended way to get started with Deenruv is by using the [@deenruv/create](https://github.com/aexol-studio/deenruv/tree/main/packages/create) tool. This is a command-line tool which will scaffold and configure your new Deenruv project and install all dependencies.
...
in the [Try the API section](/docs/guides/getting-started/try-the-api), as well as providing some data to use when
...
-   The Deenruv Admin GraphQL API: [http://localhost:6100/admin-api](http://localhost:6100/admin-api)
-   The Deenruv Shop GraphQL API: [http://localhost:6100/shop-api](http://localhost:6100/shop-api)
-   The Deenruv Admin UI: [http://localhost:6100/admin](http://localhost:6100/admin)

Congratulations! 🥳 You now have a fully-functional Deenruv server running locally.

Now you can explore Deenruv by following our [Try the API guide](/docs/guides/getting-started/try-the-api) to learn how to interact with the server.

If you are new to GraphQL, you should also check out our [Introducing GraphQL guide](/docs/guides/getting-started/graphql-intro).

<Callout type="info">
Open the Admin UI at [http://localhost:6100/admin](http://localhost:6100/admin) in your browser and log in with the superadmin credentials you specified, which default to:
...
We have a number of storefront starter kits available for you to use - head over to the [Storefront Starters](/docs/guides/storefront/storefront-starters)
page to learn more.
