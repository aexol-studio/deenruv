...
-   [`OrderCodeStrategy`](/docs/reference/typescript-api/orders/order-code-strategy/) - determines how order codes are generated
-   [`StockLocationStrategy`](/docs/reference/typescript-api/products-stock/stock-location-strategy/) - determines which stock locations are used to fulfill an order
-   [`ActiveOrderStrategy`](/docs/reference/typescript-api/orders/active-order-strategy/) - determines how the active order in the Shop API is selected
-   [`AssetStorageStrategy`](/docs/reference/typescript-api/assets/asset-storage-strategy/) - determines where uploaded assets are stored
-   [`GuestCheckoutStrategy`](/docs/reference/typescript-api/orders/guest-checkout-strategy/) - defines rules relating to guest checkouts
-   [`OrderItemPriceCalculationStrategy`](/docs/reference/typescript-api/orders/order-item-price-calculation-strategy/) - determines how items are priced when added to the order
-   [`TaxLineCalculationStrategy`](/docs/reference/typescript-api/tax/tax-line-calculation-strategy/) - determines how tax is calculated for an order line

As an example, let's take the [`OrderCodeStrategy`](/docs/reference/typescript-api/orders/order-code-strategy/). This strategy
...
extend the underlying [`InjectableStrategy` interface](/docs/reference/typescript-api/common/injectable-strategy). In
...
For example, imagine you want to create a custom [`StockLocationStrategy`](/docs/reference/typescript-api/products-stock/stock-location-strategy/) which
...
-   [`CollectionFilter`](/docs/reference/typescript-api/configuration/collection-filter/) - determines which products are included in a collection
-   [`PaymentMethodHandler`](/docs/reference/typescript-api/payment/payment-method-handler/) - determines how payments are processed
-   [`PromotionCondition`](/docs/reference/typescript-api/promotions/promotion-condition/) - determines whether a promotion is applicable
-   [`PromotionAction`](/docs/reference/typescript-api/promotions/promotion-action/) - determines what happens when a promotion is applied
-   [`ShippingEligibilityChecker`](/docs/reference/typescript-api/shipping/shipping-eligibility-checker/) - determines whether a shipping method is available
-   [`ShippingCalculator`](/docs/reference/typescript-api/shipping/shipping-calculator/) - determines how shipping costs are calculated
...
[`ConfigArgType`](/docs/reference/typescript-api/configurable-operation-def/config-arg-type)
...
[`LocalizedStringArray`](/docs/reference/typescript-api/configurable-operation-def/localized-string-array/)
