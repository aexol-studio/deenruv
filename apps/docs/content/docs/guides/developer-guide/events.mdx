...
Deenruv emits events which can be subscribed to by plugins. These events are published by the [EventBus](/docs/reference/typescript-api/events/event-bus/) and
...
- [`AccountRegistrationEvent`](/docs/reference/typescript-api/events/event-types#accountregistrationevent)
- [`AccountVerifiedEvent`](/docs/reference/typescript-api/events/event-types#accountverifiedevent)
- [`AdministratorEvent`](/docs/reference/typescript-api/events/event-types#administratorevent)
- [`AssetChannelEvent`](/docs/reference/typescript-api/events/event-types#assetchannelevent)
- [`AssetEvent`](/docs/reference/typescript-api/events/event-types#assetevent)
- [`AttemptedLoginEvent`](/docs/reference/typescript-api/events/event-types#attemptedloginevent)
- [`ChangeChannelEvent`](/docs/reference/typescript-api/events/event-types#changechannelevent)
- [`ChannelEvent`](/docs/reference/typescript-api/events/event-types#channelevent)
- [`CollectionEvent`](/docs/reference/typescript-api/events/event-types#collectionevent)
- [`CollectionModificationEvent`](/docs/reference/typescript-api/events/event-types#collectionmodificationevent)
- [`CountryEvent`](/docs/reference/typescript-api/events/event-types#countryevent)
- [`CouponCodeEvent`](/docs/reference/typescript-api/events/event-types#couponcodeevent)
- [`CustomerAddressEvent`](/docs/reference/typescript-api/events/event-types#customeraddressevent)
- [`CustomerEvent`](/docs/reference/typescript-api/events/event-types#customerevent)
- [`CustomerGroupChangeEvent`](/docs/reference/typescript-api/events/event-types#customergroupchangeevent)
- [`CustomerGroupEvent`](/docs/reference/typescript-api/events/event-types#customergroupevent)
- [`FacetEvent`](/docs/reference/typescript-api/events/event-types#facetevent)
- [`FacetValueEvent`](/docs/reference/typescript-api/events/event-types#facetvalueevent)
- [`FulfillmentEvent`](/docs/reference/typescript-api/events/event-types#fulfillmentevent)
- [`FulfillmentStateTransitionEvent`](/docs/reference/typescript-api/events/event-types#fulfillmentstatetransitionevent)
- [`GlobalSettingsEvent`](/docs/reference/typescript-api/events/event-types#globalsettingsevent)
- [`HistoryEntryEvent`](/docs/reference/typescript-api/events/event-types#historyentryevent)
- [`IdentifierChangeEvent`](/docs/reference/typescript-api/events/event-types#identifierchangeevent)
- [`IdentifierChangeRequestEvent`](/docs/reference/typescript-api/events/event-types#identifierchangerequestevent)
- [`InitializerEvent`](/docs/reference/typescript-api/events/event-types#initializerevent)
- [`LoginEvent`](/docs/reference/typescript-api/events/event-types#loginevent)
- [`LogoutEvent`](/docs/reference/typescript-api/events/event-types#logoutevent)
- [`OrderEvent`](/docs/reference/typescript-api/events/event-types#orderevent)

</div>
<div>

- [`OrderLineEvent`](/docs/reference/typescript-api/events/event-types#orderlineevent)
- [`OrderPlacedEvent`](/docs/reference/typescript-api/events/event-types#orderplacedevent)
- [`OrderStateTransitionEvent`](/docs/reference/typescript-api/events/event-types#orderstatetransitionevent)
- [`PasswordResetEvent`](/docs/reference/typescript-api/events/event-types#passwordresetevent)
- [`PasswordResetVerifiedEvent`](/docs/reference/typescript-api/events/event-types#passwordresetverifiedevent)
- [`PaymentMethodEvent`](/docs/reference/typescript-api/events/event-types#paymentmethodevent)
- [`PaymentStateTransitionEvent`](/docs/reference/typescript-api/events/event-types#paymentstatetransitionevent)
- [`ProductChannelEvent`](/docs/reference/typescript-api/events/event-types#productchannelevent)
- [`ProductEvent`](/docs/reference/typescript-api/events/event-types#productevent)
- [`ProductOptionEvent`](/docs/reference/typescript-api/events/event-types#productoptionevent)
- [`ProductOptionGroupChangeEvent`](/docs/reference/typescript-api/events/event-types#productoptiongroupchangeevent)
- [`ProductOptionGroupEvent`](/docs/reference/typescript-api/events/event-types#productoptiongroupevent)
- [`ProductVariantChannelEvent`](/docs/reference/typescript-api/events/event-types#productvariantchannelevent)
- [`ProductVariantEvent`](/docs/reference/typescript-api/events/event-types#productvariantevent)
- [`PromotionEvent`](/docs/reference/typescript-api/events/event-types#promotionevent)
- [`ProvinceEvent`](/docs/reference/typescript-api/events/event-types#provinceevent)
- [`RefundStateTransitionEvent`](/docs/reference/typescript-api/events/event-types#refundstatetransitionevent)
- [`RoleChangeEvent`](/docs/reference/typescript-api/events/event-types#rolechangeevent)
- [`RoleEvent`](/docs/reference/typescript-api/events/event-types#roleevent)
- [`SearchEvent`](/docs/reference/typescript-api/events/event-types#searchevent)
- [`SellerEvent`](/docs/reference/typescript-api/events/event-types#sellerevent)
- [`ShippingMethodEvent`](/docs/reference/typescript-api/events/event-types#shippingmethodevent)
- [`StockMovementEvent`](/docs/reference/typescript-api/events/event-types#stockmovementevent)
- [`TaxCategoryEvent`](/docs/reference/typescript-api/events/event-types#taxcategoryevent)
- [`TaxRateEvent`](/docs/reference/typescript-api/events/event-types#taxrateevent)
- [`TaxRateModificationEvent`](/docs/reference/typescript-api/events/event-types#taxratemodificationevent)
- [`ZoneEvent`](/docs/reference/typescript-api/events/event-types#zoneevent)
- [`ZoneMembersEvent`](/docs/reference/typescript-api/events/event-types#zonemembersevent)
...
You can create your own custom events by extending the [`DeenruvEvent`](/docs/reference/typescript-api/events/deenruv-event) class. For example, to create a custom event which is triggered when a customer submits a review, you could do this:
...
The API described in this section was added in Deenruv v2.2.0.
</Callout>
