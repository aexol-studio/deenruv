...
- **Panel administracyjny** pod adresem `http://localhost:6100/admin`
- **Shop API** pod adresem `http://localhost:6100/shop-api`
- **Admin API** pod adresem `http://localhost:6100/admin-api`
