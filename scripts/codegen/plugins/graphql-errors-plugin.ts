...
function isGraphQLError(input: any): input is import('@deenruv/common/lib/generated-types').${ERROR_INTERFACE_NAME} {
...
function isUnionOfResultAndErrors(
  schema: GraphQLSchema,
...
function isObjectTypeDefinition(node: any): node is ObjectTypeDefinitionNode {
  return (
    node && isTypeDefinitionNode(node) && node.kind === "ObjectTypeDefinition"
  );
}
