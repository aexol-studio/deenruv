...
/**
 * For some unknown reason, a v1.2.2 of @deenruv/core included incorrect type definitions for some types.
 ...
 *
 * Example:
 * [dummy-payment-method-handler.d.ts](https://unpkg.com/@deenruv/core@1.2.2/dist/config/payment/dummy-payment-method-handler.d.ts)
 * ```
...
const filesToCheck = [
  ...
  path.join(
    configPath,
    "promotion/actions/product-percentage-discount-action.d.ts",
  ),
  path.join(
    configPath,
    "promotion/conditions/contains-products-condition.d.ts",
  ),
  path.join(configPath, "shipping-method/default-shipping-calculator.d.ts"),
  path.join(
    configPath,
    "shipping-method/default-shipping-eligibility-checker.d.ts",
  ),
