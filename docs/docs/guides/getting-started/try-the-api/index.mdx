...
Once you have successfully installed Deenruv locally following the [installation guide](/guides/getting-started/installation),
...
:::info
For more information about `ErrorResult` and the handling of errors in Deenruv, see the [Error Handling guide](/guides/developer-guide/error-handling).
:::
