...
-   The [supported TypeScript version](https://github.com/aexol-studio/deenruv/blob/master/packages/create/src/constants.ts#L7) is set upon installation. Upgrading to a newer version of TypeScript might result in compilation errors.
...
-   If you use **Yarn**, from Deenruv v2.2.0+, you'll need to use **Yarn 2** (Berry) or above.

## @deenruv/create

The recommended way to get started with Deenruv is by using the [@deenruv/create](https://github.com/aexol-studio/deenruv/tree/master/packages/create) tool. This is a command-line tool which will scaffold and configure your new Deenruv project and install all dependencies.
...
![Deenruv Create step 2](./create-2.webp)
...
![Deenruv Create step 3](./create-3.webp)
...
-   The Deenruv Admin GraphQL API: [http://localhost:3000/admin-api](http://localhost:3000/admin-api)
-   The Deenruv Shop GraphQL API: [http://localhost:3000/shop-api](http://localhost:3000/shop-api)
-   The Deenruv Admin UI: [http://localhost:3000/admin](http://localhost:3000/admin)

Congratulations! 🥳 You now have a fully-functional Deenruv server running locally.

Now you can explore Deenruv by following our [Try the API guide](/guides/getting-started/try-the-api/) to learn how to interact with the server.
