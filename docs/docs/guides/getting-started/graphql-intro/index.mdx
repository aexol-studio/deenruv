...
:::info
In Deenruv, we use this pattern for almost all mutations. You can read more about it in the [Error Handling guide](/guides/developer-guide/error-handling/).
:::
...
This is a GraphQL Playground running on a real Deenruv server. You can run the query by clicking the "play" button in the
