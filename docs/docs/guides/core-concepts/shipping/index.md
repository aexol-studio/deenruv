...
import { defaultShippingEligibilityChecker, VendureConfig } from '@deenruv/core';
...
```ts
import { defaultShippingCalculator, VendureConfig } from '@deenruv/core';
...
```ts title="src/vendure-config.ts"
import { FulfillmentProcess, VendureConfig } from '@deenruv/core';
