...
Email is the most common way to notify customers of events, so a default Deenruv installation includes our [EmailPlugin](/reference/core-plugins/email-plugin).
...
-   [AWS SES](https://www.deenruv.io/marketplace/aws-ses)
-   [SendGrid](https://www.deenruv.io/marketplace/sendgrid)
...
import { PluginCommonModule, VendurePlugin, EventBus } from '@deenruv/core';
import { OrderStateTransitionEvent } from '@deenruv/core';
