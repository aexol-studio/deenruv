...
When you create a Vendure project with `@deenruv/create`, it comes with the [dotenv](https://www.npmjs.com/package/dotenv) package installed, which allows you to store environment variables in a `.env` file in the root of your project.
...
import { AssetServerPlugin, DefaultJobQueuePlugin, VendureConfig } from '@deenruv/core';
