...
// Note: we are using a deep import here, rather than importing from `@deenruv/core` due to
...
import { CustomProductFields } from '@deenruv/core/dist/entity/custom-entity-fields';
