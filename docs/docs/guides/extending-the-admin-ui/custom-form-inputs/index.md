...
import { IntCustomFieldConfig, SharedModule, FormInputComponent } from '@deenruv/admin-ui/core';
...
import { RelationCustomFieldConfig } from '@deenruv/common/lib/generated-types';
