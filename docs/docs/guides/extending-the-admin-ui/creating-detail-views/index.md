...
export class ReviewDetailComponent
    extends TypedBaseDetailComponent<typeof getReviewDetailDocument, 'review'>
    implements OnInit, OnDestroy
{
    ...
    protected setFormValues(
        entity: NonNullable<ResultOf<typeof getReviewDetailDocument>['review']>,
...
} from './components/review-detail/review-detail.component';
...
```ts title="src/plugins/reviews/ui/components/review-detail/review-detail.component.ts"
// highlight-next-line
import { getCustomFieldsDefaults } from '@deenruv/admin-ui/core';
