...
```ts title="src/plugins/my-plugin/ui/components/test/test.component.ts"
import { SharedModule, NotificationService } from '@deenruv/admin-ui/core';
import { Component } from '@angular/core';
...
```ts title="src/plugins/my-plugin/ui/components/test/test.component.ts"
import { PageMetadataService, SharedModule } from '@deenruv/admin-ui/core';
import { Component } from '@angular/core';
...
```tsx title="src/plugins/my-plugin/ui/components/Test.tsx"
import { Card, usePageMetadata } from '@deenruv/admin-ui/react';
import React from 'react';
...
```ts title="src/plugins/my-plugin/ui/routes.ts"
import { GetProductDetailDocument, registerRouteComponent } from '@deenruv/admin-ui/core';
...
```ts title="src/plugins/my-plugin/ui/routes.ts"
import { GetProductDetailDocument } from '@deenruv/admin-ui/core';
import { registerReactRouteComponent } from '@deenruv/admin-ui/react';
