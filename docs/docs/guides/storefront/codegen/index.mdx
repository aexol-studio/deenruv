...
:::note
This guide is for adding codegen to your storefront. For a guide on adding codegen to your backend Deenruv plugins or UI extensions, see the [Plugin Codegen](/guides/how-to/codegen/) guide.
:::
