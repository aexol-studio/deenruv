...
[Northflank](https://northflank.com) is a comprehensive developer platform to build and scale your apps. It has an outstanding developer experience and has a free tier for small projects, and is well-suited for deploying and scaling Deenruv applications.

This guide will walk you through the steps to deploy [a sample Deenruv application](https://github.com/deenruv-ecommerce/one-click-deploy) to Northflank.
...
A template defines the infrastructure that is needed to run your Deenruv server. Namely, a **server**, a **worker**,
...
:::note
This template configures a production-like setup for Deenruv, with the server and worker running in separate processes
...
{
    "apiVersion": "v1",
    "name": "Deenruv Template",
    "description": "Deenruv is a modern, open-source composable commerce platform",
    "project": {
        "spec": {
            "name": "Deenruv",
            "region": "europe-west",
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "spec": {
                        ...
                        "vcsData": {
                            "projectUrl": "https://github.com/deenruv-ecommerce/one-click-deploy",
                            "projectType": "github"
                        },
                        "buildSettings": {
                            "dockerfile": {
...
:::note
This template runs the Deenruv server & worker in a single process, and as such will fit within the
...
In the top right corner you'll see the public URL of your new Deenruv server!
...
Congratulations on deploying your Deenruv server!

## Next steps

Now that you have a basic Deenruv server up and running, you can explore some of the other features offered by Northflank
...
-   Configure [health checks](https://northflank.com/docs/v1/application/observe/configure-health-checks) to ensure any container crashes are rapidly detected and restarted. Also see the
    [Deenruv health check docs](/guides/deployment/using-docker#healthreadiness-checks).
