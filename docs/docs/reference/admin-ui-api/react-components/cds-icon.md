...
<GenerationInfo sourceFile="packages/admin-ui/src/lib/react/src/react-components/CdsIcon.tsx" sourceLine="47" packageName="@deenruv/admin-ui" />
...
import { CdsIcon } from '@deenruv/admin-ui/react';
