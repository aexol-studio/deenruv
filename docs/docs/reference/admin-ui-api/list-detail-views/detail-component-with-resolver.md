...
<GenerationInfo sourceFile="packages/admin-ui/src/lib/core/src/common/base-detail.component.ts" sourceLine="256" packageName="@deenruv/admin-ui" />
...
```ts title="Signature"
function detailComponentWithResolver<
