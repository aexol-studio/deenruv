...
<GenerationInfo sourceFile="packages/email-plugin/src/handler/event-handler.ts" sourceLine="456" packageName="@deenruv/email-plugin" />
...
```ts title="Signature"
class EmailEventHandlerWithAsyncData<
    Data,
