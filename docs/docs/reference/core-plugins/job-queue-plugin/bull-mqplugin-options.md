...
<GenerationInfo sourceFile="packages/job-queue-plugin/src/bullmq/types.ts" sourceLine="14" packageName="@deenruv/job-queue-plugin" since="1.2.0" />
...
<GenerationInfo sourceFile="packages/job-queue-plugin/src/bullmq/types.ts" sourceLine="91" packageName="@deenruv/job-queue-plugin" since="1.3.0" />
