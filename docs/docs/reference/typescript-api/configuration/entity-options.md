...
<GenerationInfo sourceFile="packages/core/src/config/vendure-config.ts" sourceLine="954" packageName="@deenruv/core" since="1.3.0" />
...
<GenerationInfo sourceFile="packages/core/src/config/entity-metadata/entity-metadata-modifier.ts" sourceLine="56" packageName="@deenruv/core" since="1.6.0" />
...
import { EntityMetadataModifier, ProductVariant } from '@deenruv/core';
...
import { EntityMetadataModifier, ProductTranslation } from '@deenruv/core';
