...
<GenerationInfo sourceFile="packages/core/src/config/deenruv-config.ts" sourceLine="1201" packageName="@deenruv/core" />
...
```ts title="Signature"
interface RuntimeVendureConfig extends Required<DeenruvConfig> {
