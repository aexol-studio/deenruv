...
<GenerationInfo sourceFile="packages/core/src/plugin/deenruv-plugin.ts" sourceLine="23" packageName="@deenruv/core" />
...
that any Nestjs Module is a valid Deenruv plugin. In addition, the VendurePluginMetadata allows the definition of
...
<MemberInfo kind="property" type={`<a href='/reference/typescript-api/plugin/deenruv-plugin-metadata#apiextensiondefinition'>APIExtensionDefinition</a>`} />
...
<GenerationInfo sourceFile="packages/core/src/plugin/deenruv-plugin.ts" sourceLine="74" packageName="@deenruv/core" />
