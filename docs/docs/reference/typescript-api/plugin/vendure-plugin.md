...
<GenerationInfo sourceFile="packages/core/src/plugin/deenruv-plugin.ts" sourceLine="151" packageName="@deenruv/core" />

The VendurePlugin decorator is a means of configuring and/or extending the functionality of the Deenruv server. A Deenruv plugin is
