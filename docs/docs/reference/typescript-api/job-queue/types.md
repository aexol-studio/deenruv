...
<GenerationInfo sourceFile="packages/core/src/job-queue/polling-job-queue-strategy.ts" sourceLine="22" packageName="@deenruv/core" />
...
<GenerationInfo sourceFile="packages/core/src/job-queue/subscribable-job.ts" sourceLine="22" packageName="@deenruv/core" />
...
<GenerationInfo sourceFile="packages/core/src/job-queue/subscribable-job.ts" sourceLine="34" packageName="@deenruv/core" />
...
<GenerationInfo sourceFile="packages/core/src/job-queue/types.ts" sourceLine="15" packageName="@deenruv/core" />
...
<GenerationInfo sourceFile="packages/core/src/job-queue/types.ts" sourceLine="37" packageName="@deenruv/core" />
...
<GenerationInfo sourceFile="packages/core/src/job-queue/types.ts" sourceLine="46" packageName="@deenruv/core" />
