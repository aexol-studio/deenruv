...
<GenerationInfo sourceFile="packages/common/src/shared-types.ts" sourceLine="215" packageName="@deenruv/common" />
...
<MemberInfo kind="property" type={`string`} default={`'deenruv-token'`} />
