...
<GenerationInfo sourceFile="packages/core/src/config/system/error-handler-strategy.ts" sourceLine="60" packageName="@deenruv/core" since="2.2.0" />
...
import { ErrorHandlerStrategy, I18nError, Injector, Job, LogLevel } from '@deenruv/core';
