...
<GenerationInfo sourceFile="packages/core/src/api/common/request-context.ts" sourceLine="44" packageName="@deenruv/core" />
...
(e.g. copy.channel.code = 'new') _will_ also affect the original.
