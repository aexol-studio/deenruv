...
Since these requirements are particular to your business needs, Deenruv does not provide any built-in checkers, but your developers can create one to suit your requirements.

## Payment handler

The payment handler contains the actual logic for processing a payment. Again, since there are many ways to handle payments, Deenruv only provides a "dummy handler" by default and it is up to your developers to create integrations.
