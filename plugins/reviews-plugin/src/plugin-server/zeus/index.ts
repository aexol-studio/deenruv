...
export type ValueTypes = {
  ["Query"]: AliasType<{
    ...
    jobsById?: [
      { jobIds: Array<string> | Variable<any, string> },
      ValueTypes["Job"],
    ];
    ...
    translateReviews?: [
      { input: ValueTypes["TranslateReviewsInput"] | Variable<any, string> },
      ValueTypes["GeneratedReviewTranslation"],
    ];
    getReviewsConfig?: ValueTypes["ReviewsConfig"];
    listReviews?: [
      {
        options?:
          | ValueTypes["ReviewListOptions"]
          | undefined
          | null
          | Variable<any, string>;
        productId?: string | undefined | null | Variable<any, string>;
        orderId?: string | undefined | null | Variable<any, string>;
      },
      ValueTypes["ReviewList"],
    ];
    getReview?: [{ id: string | Variable<any, string> }, ValueTypes["Review"]];
    getReviewInfoForProduct?: [
      { productId: string | Variable<any, string> },
      ValueTypes["ReviewInfoForProduct"],
    ];
    getReviewForOrder?: [
      { orderId: string | Variable<any, string> },
      ValueTypes["Review"],
  ...
  ["Mutation"]: AliasType<{
    ...
    assignRoleToAdministrator?: [
      {
        administratorId: string | Variable<any, string>;
    ...
    toggleExcludePromotionInOrder?: [
      {
        orderId: string | Variable<any, string>;
        promotionId: string | Variable<any, string>;
      },
      ValueTypes["Order"],
    ];
    ...
    addMembersToZone?: [
      {
        ...
        memberIds: Array<string> | Variable<any, string>;
      },
      ValueTypes["Zone"],
    ];
    ...
    changeReviewState?: [
      { input: ValueTypes["ChangeReviewStateInput"] | Variable<any, string> },
      ValueTypes["ChangeReviewStateResult"],
    ];
    changeReviewsState?: [
      {
        input:
          | Array<ValueTypes["ChangeReviewStateInput"]>
          | Variable<any, string>;
      },
      ValueTypes["ChangeReviewStateResult"],
    ];
    updateTranslationsReview?: [
      {
        input:
          | ValueTypes["UpdateTranslationsReviewInput"]
          | Variable<any, string>;
      },
      ValueTypes["Review"],
    ];
...
current session. */
  ...
  ["Node"]: AliasType<{
    ...
    ["...on MerchantPlatformSettingsEntity"]?: Omit<
      ...
      keyof ValueTypes["Node"]
    >;
    ["...on Review"]?: Omit<ValueTypes["Review"], keyof ValueTypes["Node"]>;
    __typename?: boolean | `@${string}`;
  }>;
...
which allows custom fields to be defined on user-supplies entities. */
  ...
  ["Review"]: AliasType<{
    ...
    authorEmailAddress?: boolean | `@${string}`;
    body?: boolean | `@${string}`;
    translations?: ValueTypes["ReviewTranslation"];
    product?: ValueTypes["Product"];
    productVariant?: ValueTypes["ProductVariant"];
    order?: ValueTypes["Order"];
    author?: ValueTypes["Customer"];
    keepAnonymous?: boolean | `@${string}`;
    __typename?: boolean | `@${string}`;
  }>;
  ["ReviewList"]: AliasType<{
  ...
  ["ReviewFilterParameter"]: {
    ...
    customerId?:
      ...
      | Variable<any, string>;
    _and?:
      | Array<ValueTypes["ReviewFilterParameter"]>
      | undefined
      | null
      | Variable<any, string>;
    _or?:
  ...
  ["ReviewListOptions"]: {
    ...
    take?: number | undefined | null | Variable<any, string>;
    sort?:
      | ValueTypes["ReviewSortParameter"]
      | undefined
      | null
      | Variable<any, string>;
    filter?:
      | ValueTypes["ReviewFilterParameter"]
      | undefined
      | null
      | Variable<any, string>;
    filterOperator?:
  ...
  ["ReviewsConfig"]: AliasType<{
    reviewsLanguages?: boolean | `@${string}`;
    canTranslate?: boolean | `@${string}`;
    __typename?: boolean | `@${string}`;
  }>;
  ["TranslateReviewsInput"]: {
    id: string | Variable<any, string>;
    languages: Array<ValueTypes["LanguageCode"]> | Variable<any, string>;
  };
  ["GeneratedReviewTranslation"]: AliasType<{
    languageCode?: boolean | `@${string}`;
    body?: boolean | `@${string}`;
    __typename?: boolean | `@${string}`;
  }>;
  ["ReviewInfoForProduct"]: AliasType<{
    averageRating?: boolean | `@${string}`;
    totalReviews?: boolean | `@${string}`;
    totalRatings?: boolean | `@${string}`;
    __typename?: boolean | `@${string}`;
  }>;
  ["ChangeReviewStateInput"]: {
    id: string | Variable<any, string>;
    state: ValueTypes["ReviewState"] | Variable<any, string>;
  ...
  ["UpdateTranslationsReviewInput"]: {
    id: string | Variable<any, string>;
    translations:
      | Array<ValueTypes["ReviewEntityTranslation"]>
      | Variable<any, string>;
  };
  ["ChangeReviewStateResult"]: AliasType<{
    id?: boolean | `@${string}`;
    success?: boolean | `@${string}`;
    __typename?: boolean | `@${string}`;
  }>;
...
export type ResolverInputTypes = {
  ["Query"]: AliasType<{
    ...
    translateReviews?: [
      { input: ResolverInputTypes["TranslateReviewsInput"] },
      ResolverInputTypes["GeneratedReviewTranslation"],
    ];
    getReviewsConfig?: ResolverInputTypes["ReviewsConfig"];
    listReviews?: [
      {
        options?: ResolverInputTypes["ReviewListOptions"] | undefined | null;
        productId?: string | undefined | null;
        orderId?: string | undefined | null;
      },
      ResolverInputTypes["ReviewList"],
    ];
    getReview?: [{ id: string }, ResolverInputTypes["Review"]];
    getReviewInfoForProduct?: [
      { productId: string },
      ResolverInputTypes["ReviewInfoForProduct"],
    ];
    getReviewForOrder?: [{ orderId: string }, ResolverInputTypes["Review"]];
    __typename?: boolean | `@${string}`;
  }>;
  ["Mutation"]: AliasType<{
    createAdministrator?: [
    ...
    toggleExcludePromotionInOrder?: [
      { orderId: string; promotionId: string },
      ResolverInputTypes["Order"],
    ];
    removeCouponCodeFromDraftOrder?: [
      { orderId: string; couponCode: string },
    ...
    addMembersToZone?: [
      { zoneId: string; memberIds: Array<string> },
      ResolverInputTypes["Zone"],
    ];
    removeMembersFromZone?: [
      { zoneId: string; memberIds: Array<string> },
    ...
    changeReviewState?: [
      { input: ResolverInputTypes["ChangeReviewStateInput"] },
      ResolverInputTypes["ChangeReviewStateResult"],
    ];
    changeReviewsState?: [
      { input: Array<ResolverInputTypes["ChangeReviewStateInput"]> },
      ResolverInputTypes["ChangeReviewStateResult"],
    ];
    updateTranslationsReview?: [
      { input: ResolverInputTypes["UpdateTranslationsReviewInput"] },
...
which allows custom fields to be defined on user-supplies entities. */
  ...
  ["Review"]: AliasType<{
    ...
    createdAt?: boolean | `@${string}`;
    updatedAt?: boolean | `@${string}`;
    assets?: ResolverInputTypes["ReviewAsset"];
    state?: boolean | `@${string}`;
    response?: boolean | `@${string}`;
    responseCreatedAt?: boolean | `@${string}`;
    rating?: boolean | `@${string}`;
    ...
    authorEmailAddress?: boolean | `@${string}`;
    body?: boolean | `@${string}`;
    translations?: ResolverInputTypes["ReviewTranslation"];
    product?: ResolverInputTypes["Product"];
    productVariant?: ResolverInputTypes["ProductVariant"];
    order?: ResolverInputTypes["Order"];
    author?: ResolverInputTypes["Customer"];
    keepAnonymous?: boolean | `@${string}`;
    __typename?: boolean | `@${string}`;
  }>;
  ["ReviewList"]: AliasType<{
  ...
  ["ReviewFilterParameter"]: {
    ...
    productId?: ResolverInputTypes["IDOperators"] | undefined | null;
    orderId?: ResolverInputTypes["IDOperators"] | undefined | null;
    customerId?: ResolverInputTypes["IDOperators"] | undefined | null;
    _and?:
      | Array<ResolverInputTypes["ReviewFilterParameter"]>
      | undefined
      | null;
    _or?: Array<ResolverInputTypes["ReviewFilterParameter"]> | undefined | null;
    keepAnonymous?: ResolverInputTypes["BooleanOperators"] | undefined | null;
  };
  ["ReviewSortParameter"]: {
    id?: ResolverInputTypes["SortOrder"] | undefined | null;
    createdAt?: ResolverInputTypes["SortOrder"] | undefined | null;
    ...
    authorEmailAddress?: ResolverInputTypes["SortOrder"] | undefined | null;
    body?: ResolverInputTypes["SortOrder"] | undefined | null;
  };
  ["ReviewListOptions"]: {
    skip?: number | undefined | null;
    take?: number | undefined | null;
    sort?: ResolverInputTypes["ReviewSortParameter"] | undefined | null;
    filter?: ResolverInputTypes["ReviewFilterParameter"] | undefined | null;
    filterOperator?: ResolverInputTypes["LogicalOperator"] | undefined | null;
  };
  ["ReviewsConfig"]: AliasType<{
    reviewsLanguages?: boolean | `@${string}`;
  ...
  ["TranslateReviewsInput"]: {
    id: string;
    languages: Array<ResolverInputTypes["LanguageCode"]>;
  };
  ["GeneratedReviewTranslation"]: AliasType<{
    languageCode?: boolean | `@${string}`;
    body?: boolean | `@${string}`;
  ...
  ["ChangeReviewStateInput"]: {
    id: string;
    state: ResolverInputTypes["ReviewState"];
  ...
  ["UpdateTranslationsReviewInput"]: {
    id: string;
    translations: Array<ResolverInputTypes["ReviewEntityTranslation"]>;
  };
  ["ChangeReviewStateResult"]: AliasType<{
    id?: boolean | `@${string}`;
    success?: boolean | `@${string}`;
...
export type ModelTypes = {
  ["Query"]: {
    ...
    translateReviews: Array<ModelTypes["GeneratedReviewTranslation"]>;
    getReviewsConfig: ModelTypes["ReviewsConfig"];
    listReviews: ModelTypes["ReviewList"];
    getReview?: ModelTypes["Review"] | undefined;
    getReviewInfoForProduct?: ModelTypes["ReviewInfoForProduct"] | undefined;
    getReviewForOrder?: ModelTypes["Review"] | undefined;
  };
  ["Mutation"]: {
...
as well as removing any of the group's options from the Product's ProductVariants. */
    ...
    createCronJob?: boolean | undefined;
    updateCronJob?: boolean | undefined;
    removeCronJob?: boolean | undefined;
    ...
    changeReviewState: ModelTypes["ChangeReviewStateResult"];
    changeReviewsState: Array<ModelTypes["ChangeReviewStateResult"]>;
    updateTranslationsReview: ModelTypes["Review"];
  };
  ["AdministratorListOptions"]: {
    /** Skips the first n results, for use in pagination */
  ...
  ["CreateChannelInput"]: {
    ...
    pricesIncludeTax: boolean;
    currencyCode?: ModelTypes["CurrencyCode"] | undefined;
...
sum of `OrderLine.discountedLinePrice` values. */
  ...
  ["Fulfillment"]: {
    ...
    customFields?: ModelTypes["FulfillmentCustomFields"] | undefined;
  };
  ["Payment"]: {
    nextStates: Array<string>;
    id: string;
...
* ID=1 AND (ID=2 OR ID=3): `{ facetValueFilters: [{ and: 1 }, { or: [2,3] }] }` */
  ...
  ["SearchInput"]: {
    ...
    facetValueIds?: Array<string> | undefined;
    facetValueOperator?: ModelTypes["LogicalOperator"] | undefined;
...
`UpdateAddressInput` and `CreateAddressInput` to specify the country. */
  ...
  ["FacetValueFilterParameter"]: {
    ...
    isHidden?: ModelTypes["BooleanOperators"] | undefined;
  };
  ["FacetValueSortParameter"]: {
    id?: ModelTypes["SortOrder"] | undefined;
    createdAt?: ModelTypes["SortOrder"] | undefined;
    ...
    isHidden?: ModelTypes["SortOrder"] | undefined;
...
which allows custom fields to be defined on user-supplies entities. */
  ...
  ["Review"]: {
    ...
    createdAt: ModelTypes["DateTime"];
    updatedAt: ModelTypes["DateTime"];
    assets: Array<ModelTypes["ReviewAsset"]>;
    state: ModelTypes["ReviewState"];
    ...
    body?: string | undefined;
    translations: Array<ModelTypes["ReviewTranslation"]>;
    product?: ModelTypes["Product"] | undefined;
    productVariant?: ModelTypes["ProductVariant"] | undefined;
    order?: ModelTypes["Order"] | undefined;
    author?: ModelTypes["Customer"] | undefined;
    keepAnonymous: boolean;
  };
  ["ReviewList"]: {
    items: Array<ModelTypes["Review"]>;
    totalItems: number;
  };
  ["ReviewFilterParameter"]: {
    id?: ModelTypes["IDOperators"] | undefined;
    ...
    authorEmailAddress?: ModelTypes["StringOperators"] | undefined;
    body?: ModelTypes["StringOperators"] | undefined;
    productId?: ModelTypes["IDOperators"] | undefined;
    orderId?: ModelTypes["IDOperators"] | undefined;
    customerId?: ModelTypes["IDOperators"] | undefined;
    _and?: Array<ModelTypes["ReviewFilterParameter"]> | undefined;
    _or?: Array<ModelTypes["ReviewFilterParameter"]> | undefined;
    keepAnonymous?: ModelTypes["BooleanOperators"] | undefined;
  };
  ["ReviewSortParameter"]: {
    id?: ModelTypes["SortOrder"] | undefined;
    createdAt?: ModelTypes["SortOrder"] | undefined;
    ...
    authorEmailAddress?: ModelTypes["SortOrder"] | undefined;
    body?: ModelTypes["SortOrder"] | undefined;
  };
  ["ReviewListOptions"]: {
    skip?: number | undefined;
    take?: number | undefined;
    sort?: ModelTypes["ReviewSortParameter"] | undefined;
    filter?: ModelTypes["ReviewFilterParameter"] | undefined;
    filterOperator?: ModelTypes["LogicalOperator"] | undefined;
  };
  ["ReviewsConfig"]: {
    reviewsLanguages: Array<ModelTypes["LanguageCode"]>;
    canTranslate: boolean;
  };
  ["TranslateReviewsInput"]: {
    id: string;
    languages: Array<ModelTypes["LanguageCode"]>;
  };
  ...
  ["UpdateTranslationsReviewInput"]: {
    id: string;
    translations: Array<ModelTypes["ReviewEntityTranslation"]>;
  };
...
export type GraphQLTypes = {
  ["Query"]: {
    ...
    translateReviews: Array<GraphQLTypes["GeneratedReviewTranslation"]>;
    getReviewsConfig: GraphQLTypes["ReviewsConfig"];
    listReviews: GraphQLTypes["ReviewList"];
    getReview?: GraphQLTypes["Review"] | undefined;
    getReviewInfoForProduct?: GraphQLTypes["ReviewInfoForProduct"] | undefined;
    getReviewForOrder?: GraphQLTypes["Review"] | undefined;
  };
  ["Mutation"]: {
    __typename: "Mutation";
    /** Create a new Administrator */
...
as well as removing any of the group's options from the Product's ProductVariants. */
    ...
    setInpostShippingMethodConfig: boolean;
    changeReviewState: GraphQLTypes["ChangeReviewStateResult"];
    changeReviewsState: Array<GraphQLTypes["ChangeReviewStateResult"]>;
    updateTranslationsReview: GraphQLTypes["Review"];
  };
  ["AdministratorListOptions"]: {
    /** Skips the first n results, for use in pagination */
    skip?: number | undefined;
  ...
  ["CreateChannelInput"]: {
    ...
    pricesIncludeTax: boolean;
    currencyCode?: GraphQLTypes["CurrencyCode"] | undefined;
...
sum of `OrderLine.discountedLinePrice` values. */
  ...
  ["Fulfillment"]: {
    ...
    method: string;
    trackingCode?: string | undefined;
    customFields?: GraphQLTypes["FulfillmentCustomFields"] | undefined;
  };
  ["Payment"]: {
    __typename: "Payment";
    nextStates: Array<string>;
...
current session. */
  ...
  ["PaginatedList"]: {
    ...
    ["...on ReviewList"]: "__union" & GraphQLTypes["ReviewList"];
  };
  ["Node"]: {
    __typename:
      | "Administrator"
...
* ID=1 AND (ID=2 OR ID=3): `{ facetValueFilters: [{ and: 1 }, { or: [2,3] }] }` */
  ...
  ["SearchInput"]: {
    term?: string | undefined;
    facetValueIds?: Array<string> | undefined;
    facetValueOperator?: GraphQLTypes["LogicalOperator"] | undefined;
    facetValueFilters?:
...
`UpdateAddressInput` and `CreateAddressInput` to specify the country. */
  ...
  ["FacetValueFilterParameter"]: {
    ...
    isHidden?: GraphQLTypes["BooleanOperators"] | undefined;
  };
  ["FacetValueSortParameter"]: {
    id?: GraphQLTypes["SortOrder"] | undefined;
    createdAt?: GraphQLTypes["SortOrder"] | undefined;
    ...
    isHidden?: GraphQLTypes["SortOrder"] | undefined;
...
which allows custom fields to be defined on user-supplies entities. */
  ...
  ["Review"]: {
    ...
    createdAt: GraphQLTypes["DateTime"];
    updatedAt: GraphQLTypes["DateTime"];
    assets: Array<GraphQLTypes["ReviewAsset"]>;
    state: GraphQLTypes["ReviewState"];
    response?: string | undefined;
    ...
    authorEmailAddress: string;
    body?: string | undefined;
    translations: Array<GraphQLTypes["ReviewTranslation"]>;
    product?: GraphQLTypes["Product"] | undefined;
    productVariant?: GraphQLTypes["ProductVariant"] | undefined;
    order?: GraphQLTypes["Order"] | undefined;
    author?: GraphQLTypes["Customer"] | undefined;
    keepAnonymous: boolean;
  };
  ["ReviewList"]: {
    __typename: "ReviewList";
    items: Array<GraphQLTypes["Review"]>;
    totalItems: number;
  };
  ["ReviewFilterParameter"]: {
    id?: GraphQLTypes["IDOperators"] | undefined;
    ...
    authorEmailAddress?: GraphQLTypes["StringOperators"] | undefined;
    body?: GraphQLTypes["StringOperators"] | undefined;
    productId?: GraphQLTypes["IDOperators"] | undefined;
    orderId?: GraphQLTypes["IDOperators"] | undefined;
    customerId?: GraphQLTypes["IDOperators"] | undefined;
    _and?: Array<GraphQLTypes["ReviewFilterParameter"]> | undefined;
    _or?: Array<GraphQLTypes["ReviewFilterParameter"]> | undefined;
    keepAnonymous?: GraphQLTypes["BooleanOperators"] | undefined;
  };
  ["ReviewSortParameter"]: {
    id?: GraphQLTypes["SortOrder"] | undefined;
    createdAt?: GraphQLTypes["SortOrder"] | undefined;
    ...
    authorEmailAddress?: GraphQLTypes["SortOrder"] | undefined;
    body?: GraphQLTypes["SortOrder"] | undefined;
  };
  ["ReviewListOptions"]: {
    skip?: number | undefined;
    take?: number | undefined;
    sort?: GraphQLTypes["ReviewSortParameter"] | undefined;
    filter?: GraphQLTypes["ReviewFilterParameter"] | undefined;
    filterOperator?: GraphQLTypes["LogicalOperator"] | undefined;
  };
  ["ReviewsConfig"]: {
    __typename: "ReviewsConfig";
    reviewsLanguages: Array<GraphQLTypes["LanguageCode"]>;
    canTranslate: boolean;
  };
  ["TranslateReviewsInput"]: {
    id: string;
    languages: Array<GraphQLTypes["LanguageCode"]>;
  };
  ["GeneratedReviewTranslation"]: {
    __typename: "GeneratedReviewTranslation";
    languageCode: GraphQLTypes["LanguageCode"];
    body: string;
  };
  ["ReviewInfoForProduct"]: {
    __typename: "ReviewInfoForProduct";
    averageRating: number;
    totalReviews: number;
    totalRatings: number;
  };
  ...
  ["UpdateTranslationsReviewInput"]: {
    id: string;
    translations: Array<GraphQLTypes["ReviewEntityTranslation"]>;
  };
  ["ChangeReviewStateResult"]: {
    __typename: "ChangeReviewStateResult";
    id: string;
    success: boolean;
  };
};
...
type ZEUS_VARIABLES = {
  ...
  ["ReviewState"]: ValueTypes["ReviewState"];
  ["ReviewFilterParameter"]: ValueTypes["ReviewFilterParameter"];
  ["ReviewSortParameter"]: ValueTypes["ReviewSortParameter"];
  ["ReviewListOptions"]: ValueTypes["ReviewListOptions"];
  ["TranslateReviewsInput"]: ValueTypes["TranslateReviewsInput"];
  ["ChangeReviewStateInput"]: ValueTypes["ChangeReviewStateInput"];
  ["ReviewEntityTranslation"]: ValueTypes["ReviewEntityTranslation"];
  ["UpdateTranslationsReviewInput"]: ValueTypes["UpdateTranslationsReviewInput"];
};
