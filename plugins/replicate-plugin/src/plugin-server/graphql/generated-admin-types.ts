...
export type GetPredictionInput = {
  prediction_id: Scalars['String']['input'];
};
...
export type Mutation = {
  ...
  startModelTraining: Scalars['String']['output'];
  startOrderExportToReplicate: Scalars['String']['output'];
...
export type PredictionResult = {
  ...
  predictions?: Maybe<Array<Prediction>>;
...
export type ReplicateEntity = Node & {
...
export type ReplicateEntityList = PaginatedList & {
  __typename?: 'ReplicateEntityList';
  items: Array<ReplicateEntity>;
  totalItems: Scalars['Int']['output'];
};

export type ReplicateEntityListOptions = {};
...
export type StartModelTrainingInput = {
  endDate?: InputMaybe<Scalars['DateTime']['input']>;
  numLastOrder?: InputMaybe<Scalars['Int']['input']>;
  startDate?: InputMaybe<Scalars['DateTime']['input']>;
};
