...
import { createTableHeader, createTableRow } from './pdf-creating-helpers.js';
                ...
                >
                    <View style={{ ...s.flexCol, width: '100%' }}>
                        ...
                        <View style={{ ...s.flexCol, marginTop: 8, fontSize: 10 }}>
                            {Object.entries(data.sellerAdditional).map(([key, value], index) => (
                    ...
                    <View style={{ ...s.flexCol, width: '100%' }}>
                        <Text style={{ fontWeight: 'medium', ...s.mdText }}>{data.buyerL}</Text>
                        <View style={{ ...s.flexCol, fontSize: 10 }}>
                    ...
                    <View style={{ display: 'flex', width: 'auto' }}>
                        ...
                        >
                            ...
                            >
                                ...
                                />
                                <View style={{ ...s.flex, ...s.mdText }}>
                                    <View style={{ width: '100%', textAlign: 'center', fontSize: 10 }}>
                                        {/* <Text>{data.vat}%</Text> */}
                                    </View>
