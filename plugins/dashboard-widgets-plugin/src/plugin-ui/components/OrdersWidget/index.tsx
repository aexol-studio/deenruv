...
import { differenceInDays, endOfWeek, format, isValid, parse, startOfWeek, subWeeks } from 'date-fns';
...
import { BetterMetricsChartDataType, DateRangeType, GroupBy } from '../../types';
...
export const OrdersWidget = () => {
    ...
    const [metricRangeTypeSelectValue, setMetricRangeTypeSelectValue] = useState<MetricRangeType>();
    ...
    >([]);
    const [selectedOrderStates, setSelectedOrderStates] = useState<Array<ORDER_STATE[keyof ORDER_STATE]>>([
        'PaymentSettled',
        'PartiallyShipped',
        'Shipped',
        'PartiallyDelivered',
    ...
    const fetchData = useCallback(async () => {
        try {
            ...
            if (range.end) {
                ...
                interval = diffrenceInDays > 0 ? MetricIntervalType.Day : MetricIntervalType.Hour;
            }
    ...
    return (
        <Card className="border-0 shadow-none pr-6 py-6 ">
            ...
            <OrdersSummaryTile orderStates={selectedOrderStates as string[]} dateRange={dateRange} />
            ...
            <CardContent className="p-0 mr-6 mb-6">
                <div
                    className={cn(
                        ...
                        metricType === ChartMetricType.OrderTotalProductsCount && 'opacity-100 select-auto',
                    )}
                >
                    <ProductSelector
                ...
                <OrdersChart
                    shouldShowCompare={
                        metricRangeTypeSelectValue === MetricRangeType.Custom ? false : shouldShowCompare
                    }
                    selectedAvailableProducts={selectedAvailableProducts}
                    data={groupedData}
                    language={language}
