...
export type Mutation = {
    ...
    startGenerateSimpleBG: Scalars['String']['output'];
...
export type MutationStartGenerateSimpleBgArgs = {
    input: StartGenerateSimpleBGInput;
};

export type MutationStartModelTraningInputeArgs = {
    input: StartModelTraningInput;
};
...
export type StartGenerateSimpleBGInput = {
    assetId: Scalars['ID']['input'];
    roomType: Scalars['String']['output'];
    roomStyle: Scalars['String']['output'];
    prompt: Scalars['String']['output'];
};

export type AssignPredictionToProductInput = {
    productId: Scalars['ID']['input'];
    predictionId: Scalars['ID']['input'];
};

export type StartModelTraningInput = {
    endDate?: InputMaybe<Scalars['DateTime']['input']>;
    numLastOrder?: InputMaybe<Scalars['Int']['input']>;
    predictType?: InputMaybe<PredictionType>;
    startDate?: InputMaybe<Scalars['DateTime']['input']>;
