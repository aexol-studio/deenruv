...
@DeenruvPlugin({
  ...
  configuration: (config) => {
    ...
    config.customFields.Product.push({
      ...
      type: "localeString",
      label: [
        { languageCode: LanguageCode.en, value: "listLocaleString Test" },
      ],
    });
    config.customFields.Product.push({
      name: "listLocaleText",
    ...
    config.customFields.Facet.push({
      ...
      list: true,
      label: [
        { languageCode: LanguageCode.en, value: "list product variant test" },
      ],
    });
...
export class DeenruvExamplesServerPlugin {}
