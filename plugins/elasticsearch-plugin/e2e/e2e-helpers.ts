...
import {
  SEARCH_GET_PRICES,
  SEARCH_PRODUCTS,
} from "./elasticsearch-plugin.e2e-spec";
import {
...
export function doAdminSearchQuery(
...
export async function testMatchFacetValueFiltersAnd(
  client: SimpleGraphQLClient,
) {
  const result = await client.query<
    SearchProductsShopQuery,
...
export async function testMatchFacetValueFiltersOr(
  client: SimpleGraphQLClient,
) {
  const result = await client.query<
    SearchProductsShopQuery,
...
export async function testMatchFacetValueFiltersOrWithAnd(
  client: SimpleGraphQLClient,
) {
  const result = await client.query<
    SearchProductsShopQuery,
...
export async function testMatchFacetValueFiltersWithFacetIdsOr(
  client: SimpleGraphQLClient,
) {
  const result = await client.query<
    SearchProductsShopQuery,
...
export async function testMatchFacetValueFiltersWithFacetIdsAnd(
  client: SimpleGraphQLClient,
) {
  const result = await client.query<
    SearchProductsShopQuery,
