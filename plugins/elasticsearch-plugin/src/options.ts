...
export interface ElasticsearchOptions {
  ...
  customProductVariantMappings?: {
    [fieldName: string]: CustomMapping<
      [ProductVariant, LanguageCode, Injector, RequestContext]
    >;
  };
  /**
   * @description
...
export type ElasticsearchRuntimeOptions = DeepRequired<
  Omit<ElasticsearchOptions, "clientOptions">
> & {
  clientOptions?: ClientOptions;
};
