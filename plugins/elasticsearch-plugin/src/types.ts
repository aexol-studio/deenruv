...
export type BulkOperation = {
  [operation in BulkOperationType]?: { _id: string };
};
...
type UpdateProductJobData = NamedJobData<
  "update-product",
  UpdateProductMessageData
>;
type UpdateVariantsJobData = NamedJobData<
  "update-variants",
  UpdateVariantMessageData
>;
type DeleteProductJobData = NamedJobData<
  "delete-product",
  UpdateProductMessageData
>;
type DeleteVariantJobData = NamedJobData<
  "delete-variant",
  UpdateVariantMessageData
>;
type UpdateVariantsByIdJobData = NamedJobData<
...
type AssignProductToChannelJobData = NamedJobData<
  "assign-product-to-channel",
  ProductChannelMessageData
>;
type RemoveProductFromChannelJobData = NamedJobData<
  "remove-product-from-channel",
  ProductChannelMessageData
>;
type AssignVariantToChannelJobData = NamedJobData<
  "assign-variant-to-channel",
  VariantChannelMessageData
>;
type RemoveVariantFromChannelJobData = NamedJobData<
...
export type PrimitiveTypeVariations<T extends GraphQlPrimitive> =
  | T
  | `${T}!`
  | `[${T}!]`
  | `[${T}!]!`;
...
export type CustomMapping<Args extends any[]> = {
  [Type in GraphQlPermittedReturnType]: CustomMappingDefinition<
    Args,
    Type,
    GraphQlTypeMap[Type]
  >;
...
type CustomScriptMappingDefinition<
  Args extends any[],
  T extends GraphQlPermittedReturnType,
> = {
  graphQlType: T;
...
export type CustomScriptMapping<Args extends any[]> = {
  [Type in GraphQlPermittedReturnType]: CustomScriptMappingDefinition<
    Args,
    Type
  >;
}[GraphQlPermittedReturnType];
