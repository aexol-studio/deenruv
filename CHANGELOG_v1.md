...
*Note: only the `@deenruv/email-plugin` package was updated in this release, as v0.6.2 included a critical bug which prevented installation via `@deenruv/create`*
...
* **admin-ui** Expose public API at @deenruv/admin-ui/devkit ([c2742ec](https://github.com/vendure-ecommerce/vendure/commit/c2742ec))
